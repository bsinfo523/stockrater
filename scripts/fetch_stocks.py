...
def main():
    ...
    # Alte stocks.json laden – übernehme Verlaufsdaten UND
    # behalte custom-Aktien die dieses Mal nicht abgerufen wurden
    old_stocks_by_sym = {}
    if os.path.exists(OUTPUT_FILE):
        try:
            ...
            print(f"  Alte stocks.json gelesen: {len(old_stocks_by_sym)} Einträge")
        except Exception as e:
            print(f"  ⚠ Alte stocks.json konnte nicht gelesen werden: {e}")
